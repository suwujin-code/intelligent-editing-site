...
const caseStudies = {
  ...
  renovationQuote90: {
    ...
    title: 'GZ10｜水电毛坯施工清单动画',
    source: '9:16 · 9 秒 · 1080×1920 · H.264',
    aspect: 'portrait',
    status: '技术QA通过 · 对外待审批',
    ...
    packageUrl: 'https://drive.google.com/file/d/1ivZOeNd9qezjQUhdMQz4usjnDiALf6Rn/view?usp=drivesdk',
    note: '把“水电报价不能只看总价”拆回毛坯施工现场：水路、电路和点位先出现，再由三张带 SPBD 物理回弹与锚点约束的证据卡，锁定材料／规格、数量／回路、施工／增项。',
    testGoal: '验证装修科普的趣味可以来自证据拆解：抽象报价词回到实际管线和点位，同时保持毛坯阶段语义与内容边界。',
    testMethod: '空房轮廓 → 水电管线 → 三类报价证据卡；卡片按锚点吸附、回弹和锁定，最后落到“先看清，再比总价”。',
    tags: ['装修动画', '水电报价', 'SPBD物理仿真'],
    category: '导演样片',
    outcome: '材料 → 数量 → 施工',
    role: '导演 + 信息设计 + SPBD',
    proof: ['9 秒', '1080×1920', '3 项证据卡', '锚点约束', '技术QA PASS'],
    productionRules: ['毛坯阶段先于装饰', '证据卡回到管线锚点', '趣味来自拆解而非随机特效'],
    reuse: '换选题时只替换报价证据、管线锚点与口播；保留“空场 → 发生地点 → 证据卡 → 锁定规则”的结构，并在真实配音后重新生成字幕。',
    reuseReady: true
  },
